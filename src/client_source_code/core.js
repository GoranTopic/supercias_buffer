(
    function(a) {
        // a is the windows obect passed
        if (a.PrimeFaces) { // if it is already defined
            a.PrimeFaces.debug("PrimeFaces already loaded, ignoring duplicate execution.");
            return
        }
        // what is b? 
        // is it a objec of functions...
        var b = {
            ...
            createWidget: function(d, f, c) {
                ...
                if (this.widget[d]) { // if we found a valid widget
                    ...
                    if (e && (e.constructor === this.widget[d])) {
                        ...
                        a.widgets[f] = new this.widget[d](c);
        ...
        // this is the end of the definition of b
        ...
        ;
        // OHHHHHh b is the definiotn of PrimaryFaces, lovely...
        // it get added to window
        a.PrimeFaces = b
    }
    // this function run with the window passed to it 
)(window);


// if the PrimaryFaces eviroment is note defined, then run...
// PrimeFaces.env is not found in the above definition of b,
// I belive this might be so that the page can load again and redefine PrimaryFaces
if (!PrimeFaces.env) {
    PrimeFaces.env = {
        mobile: false,
        touch: false,
    ...
    PrimeFaces.env.init()
}; // this defines the enviroment that the Primary face is abel tot gather, i think al least...
                ...
                var t = $.ajax(p).fail(function(A, i, z) {
                    ...
                    try {
                        ...
                        if (z) {
                            ...
                            PrimeFaces.ajax.Response.handle(B, i, C)
                        }
                    } catch (A) {
                        PrimeFaces.error(A)
                    }
